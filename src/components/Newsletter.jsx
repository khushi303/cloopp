    ...
    return (
        <div className='bg_news position-relative'>
            <div data-aos="zoom-in-up" className='container'>
                ...
                <p className='ff_outfit fw-normal fs_2sm text-center text-white op_90 lh_151 mt-3 mb-lg-4 pb-lg-2'>Subscribe to our newsletter for the latest news, offers, and eco-tips.</p>
                <div className='mt-4 bor_email mx-auto d-flex'>
                    <input type="text" placeholder='Enter your email' className='w-100 border-0 input_mail ff_outfit fw-normal fs_2sm op_80 bg-transparent pr_20 text-white pe-3' />
            ...
            <div className='position-absolute bt_black start-0 end-0'>
                <img src={Black_layer} alt="Black_layer" className='w-100 h_layer object-fit-cover' />
            </div>
        </div>
    )
}
