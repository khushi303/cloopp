...
const GreenerWorld = () => {
    return (
        <div id='career' className=' pt-md-4 pb-lg-5 pb-4 position-relative'>
            <h3 data-aos="fade-right" className='ff_outfit fs_lg fw-semibold text-center text_boldblack lh_120 mx-auto mb-5 px-lg-0 px-4'>Creating a Greener World Is <span className='d-lg-block'>Now As Easy As 1-2-3</span></h3>
            <div className='container'>
                <div className='row justify-content-lg-between justify-content-center'>
                    <div data-aos="zoom-in" className='col-lg-5 col-sm-9 col-10 d-flex align-items-center justify-content-center'>
                        <div>
                    ...
                    <div data-aos="zoom-in" className='col-lg-6 col-12 mt-lg-0 mt-5'>
                        <div>
                            ...
                            <h3 className='mt-3 pt-1 ff_outfit fs_md lh_125 fw-medium mb-2'>Scan The Barcode Before Recycling</h3>
                            <p className='ff_outfit fw-normal f_2sm lh_151 text_boldblack mw_lg_501 mb-0 op_80'>Open Cloopp, scan the product's barcode, and rack up points with every item you keep out of the landfill.</p>
                        </div>
                        <div className='mt-4'>
                            <div className='black_box d-flex align-items-center justify-content-center'>
                                <p className='ff_outfit fs_2md fw-semibold lh_110 text_yellow mb-0'>2</p>
                            </div>
                            <h3 className='mt-3 pt-1 ff_outfit fs_md lh_125 fw-medium mb-2'>Get Paid For Products You Use</h3>
