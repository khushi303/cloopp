                    ...
                    <div className=' col-lg-6 col-12 mt-lg-0 mt-4'>
                        <div className='row justify-content-between'>
                            <ul className='list-unstyled d-flex flex-column gap-3 col-sm-3 col-6 mb-0'>
                                <li className='ff_outfit fs_2sm fw-normal op_80 text-white lh_100 '>About Us</li>
                            ...
                            <ul className='list-unstyled d-flex flex-column gap-3 mb-0  col-sm-4 col-6'>
                                <li className='ff_outfit fs_2sm fw-normal op_80 text-white lh_100'>Terms & Conditions</li>
